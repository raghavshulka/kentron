  ...
  return (
    <div className="min-h-screen bg-black text-white py-32 px-4">
      <div className="container mx-auto max-w-4xl">
        ...
        <p className="   pt-4 " >
          <strong>Multi-Platform Integration:</strong> Kentron's multi-platform
          integration gathers data from various sources, such as Slack,
          Microsoft Teams, JIRA, Confluence, Google Drive, Gmail, and more,
          providing a unified solution to capture all relevant data regardless
          of its source.
        </p>
        <p className="   py-4 ">
        ...
        <p>
          ...
          designed with a "Security First" approach, ensuring robust data
          protection. We utilize encryption for data both in transit and at rest
          and implement role-based access controls to restrict access to
