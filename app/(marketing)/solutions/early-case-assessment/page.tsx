    ...
    <div className="min-h-screen bg-black text-white py-32 px-4">
      <div className="container mx-auto max-w-4xl">
        ...
        <ol className="list-decimal list-inside space-y-4 mt-4">
          ...
          <li>
            <strong>Cost Efficiency:</strong> Addressing a case early can lead
            to substantial cost savings. Identifying potential issues or areas
            of concern at the outset can prevent unnecessary legal expenses. For
            example, early assessment might reveal that a case is unlikely to
            succeed, leading to a decision to negotiate a settlement rather than
            pursuing a costly trial. This proactive approach helps in budgeting
          ...
          <li>
            <strong>Streamlined Discovery Process:</strong> Early assessment
            often includes a preliminary review of evidence and potential
            discovery issues. By identifying key evidence and potential pitfalls
            early, the discovery process can be streamlined, reducing the
            likelihood of disputes or delays. This efficiency can lead to a
            smoother litigation process and quicker resolution.
          </li>
        </ol>
        ...
        <p className=" py-4">
          ...
          file types of business plans, contract agreements, compensation
          policies, etc.
        </p>
        <p>
