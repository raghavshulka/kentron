  ...
  const features = [
    {
      ...
      example:
        "A university receives a <strong>FERPA</strong> request from a parent seeking access to their child's educational records. An eDiscovery solution enables administrators to quickly search and retrieve relevant documents while ensuring confidential information is protected.",
      conclusion:
